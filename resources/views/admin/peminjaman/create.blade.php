...
<div class="max-w-2xl mx-auto bg-slate-800 p-8 rounded-xl shadow-lg">
    ...
    <h1 class="text-2xl font-bold mb-6 text-indigo-400">Tambah Peminjaman</h1>
    ...
    <form action="{{ route('admin.peminjaman.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="date" name="tanggal_pinjam" class="w-full p-2 rounded text-black" value="{{ old('tanggal_pinjam') }}">
        ...
        <div>
            ...
            <input type="date" name="tanggal_kembali" class="w-full p-2 rounded text-black" value="{{ old('tanggal_kembali') }}">
